...
export class Stage extends StageBase<InitStateType, ChatStateType, MessageStateType, ConfigType> {
    ...
    buildBoard(): string {
        ...
        let result = `---\n`;
        let lines = fen.split('/');
        result += `<div style="width: ${this.boardScale}%; padding-bottom: ${this.boardScale * 0.6}%; border: 5px solid darkslategray; border-radius: 5px; position: relative; display: table; font-family: monospace; font-style: italic;"><div style="width: 60%; height: 100%; position: absolute; top: 0; left: 0; background: darkslategray">`;
    ...
    buildDiscard(): string {
        let result = `<div style="width: 40%; height: 100%; position: absolute; float: right; top: 0; right: 0;  background: darkslategray;"><div style="width: 100%; height: 50%; display: flex;">`;
